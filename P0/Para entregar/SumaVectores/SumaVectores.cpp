...
#include <cstdlib.h>     // biblioteca con funciones atoi(), malloc() y free()
#include <iostream>      // biblioteca donde se encuentra la función printf()
#include <time.h>        // biblioteca donde se encuentra la función clock_gettime()

//#define COUT_ALL      // comentar para quitar el printf ...
...
int main(int argc,char** argv){
  ...
  double *v1, *v2, *v3;
  v1 = new double [N];  // malloc necesita el tamaño en bytes
  v2 = new double [N];  //si no hay espacio suficiente malloc devuelve NULL
  v3 = new double [N];
  #endif
